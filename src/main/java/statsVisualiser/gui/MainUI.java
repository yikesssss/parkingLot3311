...
public class MainUI extends JFrame {
	...
	private MainUI() {
		...
		JLabel h1 = new JLabel("YorkU Parking Booking System");
		top.add(h1);
		
//		JButton rsBttn = new JButton("Reserve Parking Spot");
//		JButton payBttn = new JButton("Pay here");
//		mid.add(payBttn);
//		mid.add(rsBttn);
...
//	}
	...
	public static void main(String[] args) {
		...
		JFrame frame2 = RegisterUI.getInstance();
		frame2.setSize(900, 600);
		
		JFrame frame3 = ParkingGUI.getInstance();
